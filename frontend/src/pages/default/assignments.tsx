...
export default function AssignmentsPage() {
  ...
  const assignments: AssignmentWithDetails[] = React.useMemo(() => {
    return apiAssignments.map((a) => ({
      ...
      total_fee: a.total_fee ?? null,
      advance_fee: a.advance_fee ?? null,
      location: a.location,
      employment_type: a.employment_type,
      hours_per_week_min: a.hours_per_week_min ?? null,
      hours_per_week_max: a.hours_per_week_max ?? null,
      start_date: a.start_date,
      end_date: a.end_date ?? null,
      benefits: a.benefits,
      notes_image_url: a.notes_image_url,
      role_profile_url: a.role_profile_url,
      role_profile_download_url: a.role_profile_download_url,
      role_profile_original_filename: a.role_profile_original_filename,
      role_profile_kind: a.role_profile_kind,
      candidates: [],
    }));
  }, [apiAssignments]);
