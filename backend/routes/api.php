...
Route::prefix('/v1')->group(function () {
    ...
    Route::middleware('auth.tenant')->group(function () {
        ...
        // Accounts - owners, admins, and recruiters can manage
        Route::apiResource('accounts', AccountController::class)->only(['index', 'store', 'show', 'update', 'destroy']);

        // Account Activities
        Route::get('/accounts/{account}/activities', [App\Http\Controllers\AccountActivityController::class, 'index']);
        Route::post('/accounts/{account}/activities', [App\Http\Controllers\AccountActivityController::class, 'store']);
        Route::delete('/activities/{accountActivity}', [App\Http\Controllers\AccountActivityController::class, 'destroy']);
    });
});
